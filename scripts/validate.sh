...
skills/brainstorm/SKILL.md|核心门禁|brainstorm has hard gate against premature implementation
skills/brainstorm/SKILL.md|太简单|brainstorm rejects too-simple-to-design anti-pattern
skills/brainstorm/SKILL.md|分解|brainstorm decomposes mega-tasks into sub-projects
